...
<body class="client-delete">
	<h1>회원 삭제</h1>
	ID : ${clnt.id}/PW: ${clnt.pw}  ${clnt.name}님의 회원정보를 삭제합니다.<p>
	확인을 위해 비밀번호(PW)를 입력해주세요<p>
	<form action="<c:url value = '/client/delete'/>" method="post" id="deleteClient">
	확인:<input type="text" name="pw">
	<input type="hidden" name="id" value="${clnt.id}">
