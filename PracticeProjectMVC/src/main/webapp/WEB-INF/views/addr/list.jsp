...
<script type="text/javascript" src="<c:url value='/javaScript/Addr.js'/>"></script>
</head>
<body>
<div class="addrMain-page">
		<form action="<c:url value='/addr/orderby' />" method="get">
			<div id="top-menu">
			<h5>${id} 님의 주소록입니다</h5>
			<a href="<c:url value='/client/user?id=${id}'/>" class="button">회원정보</a>
	...
	<div id="bottom-menu">
		...
		<form name="listMain" action="Addr.js">
