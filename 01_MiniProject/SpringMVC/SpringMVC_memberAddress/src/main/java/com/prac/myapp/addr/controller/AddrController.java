...
public class AddrController {
	...
	@GetMapping("/orderby")
	public ModelAndView orderbyList(String id,String value,String orderby){
	...
	@GetMapping("/search")
	public String getAllAddrName(String id,String name,
			Model model){
	...
	@GetMapping("/{phone}")
	public String getAddrInfo(@PathVariable String phone,String id, Model model) {
	...
	@GetMapping("/insert")
	public String insertAddr(String id,Model model) {
		model.addAttribute("id",id);
	...
	@GetMapping("/update")
	public String updateAddr(String id,String phone,
			Model model) {
	...
	@GetMapping("/delete")
	public String deleteAddr(String id,String phone,
			Model model) {
		model.addAttribute("addr",addrService.getAddrInfo(id, phone));
	...
	@PostMapping("/delete")
	public String deleteAddr(String id,String phone,String confirm
			, Model model){
